...
개발자의 개인적인 역량만으로 그 조직의 `기술력`을 설명하기는 어렵습니다. 아무리 뛰어난 개발자들이 모여 있더라도 그들의 **지식**과 **경험**이 공유되지 못한다면, 결국 조직이 아닌 개인의 역량일 뿐입니다. 
...
문제를 해결하는 과정에서 습득된 **지식**과 **경험**이 조직 전체로 전파되어야 비로소 조직의 역량으로 축적될 수 있습니다. 이렇게 축적된 역량은 필요할 때 언제든지 활용할 수 있는 조직의 기술 자산이 됩니다. 결국, 조직의 기술 자산이 `기술력`으로 표출되는 것입니다.

그래서 소프트웨어 개발 조직의 `기술력`은 개인의 역량이 아니라, 조직에 축적된 **지식**과 **경험**에서 만들어지는 것으로 설명할 수 있습니다.

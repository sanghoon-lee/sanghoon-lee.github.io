...
만약 여러 노드가 동시에 Active 노드로 선출된다면 데이터의 일관성이 깨지거나 예상하지 못한 문제가 발생할 수 있습니다. 여러 노드가 동시에 Active가 되면 서로 다른 데이터를 저장하거나 동일한 요청을 중복 처리하여 데이터의 일관성이 깨질 수 있습니다.

...
지금까지 Vault HA를 이해하기 위해 필요한 핵심 개념과 동작 원리를 살펴봤습니다. 다음 포스팅에서는 Oracle VM으로 구성한 환경에서 Vault HA 클러스터를 직접 구축하고, Leader Election과 Failover가 실제로 어떻게 동작하는지 확인해보겠습니다.

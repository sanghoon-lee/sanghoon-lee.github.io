...
스프링부트는 개발 편의성을 보장하기 위해서 다양한 어노테이션을 제공하고 있습니다. 실력이 부족한 탓이겠지만, 대부분의 어노테이션에 대해서 정확히 알고 사용한다기 보다는 그냥 경험에 의존해서 습관적으로 사용하고 있는 것 같은 느낌이었습니다. 실질적으로 다른 사람에게 자신있게 사용법을 설명할 수 있는 어노테이션은 몇개 안되는 것 같습니다. 
...
결제 전체 내역을 한 번에 보고 싶을 때, 다형성 조회 기능을 활용하면 결제수단이 무엇이든 '결제'라는 개념으로 묶어서 한번에 조회하는 것이 가능합니다. 아래는 그것과 관련된 예제 코드입니다.

...
스프링은 개발 편의성을 보장하기 위해서 다양한 어노테이션을 제공하고 있습니다. 실력이 부족해서 그런지 대부분의 어노테이션에 대해서 정확히 알고 사용한다기 보다는 그냥 경험에 의존해서 습관적으로 사용하고 있는 것 같은 느낌이었습니다. 실질적으로 다른 사람에게 자신있게 사용법을 설명할 수 있는 어노테이션은 몇개 안되는 것 같습니다. 

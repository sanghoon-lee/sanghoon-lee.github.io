...
하지만 정확히 사용법을 알고 사용하기 보다는 경험에 의존해서 습관적으로 사용하고 있는 어노테이션이 대부분입니다. 그러다보니 실질적으로 다른 사람에게 자신있게 사용법을 설명할 수 있는 어노테이션은 몇개 안되는 것 같습니다. 

<img class="main-image" src="/assets/images/springboot.png" alt="스프링부트">

@MappedSuperclass도 실무에서 자주 사용하는 어노테이션입니다. 

하지만 얼마전까지도 **"어떤 경우에 사용해야 되는지?"**, **"어떻게 동작하는지?"** 등 머릿속에 개념이 명확하게 정리되어 있지 않았습니다. 

다행히 최근 토이 프로젝트를 진행하면서 조금 깊게 공부할 기회가 있었습니다.

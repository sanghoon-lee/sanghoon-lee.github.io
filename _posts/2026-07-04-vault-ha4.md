...
구조를 변경한 후에는 클라이언트가 Load Balancer의 주소인 http://127.0.0.1:8000으로만 요청을 보내면 됩니다. 이후에는 Load Balancer가 요청을 전달할 노드를 선택합니다.
...
가장 먼저 Nginx 설정 파일을 저장할 디렉토리를 생성했습니다.
...
생성한 디렉토리로 이동한 뒤 nginx.conf 파일을 다음과 같이 작성했습니다.
